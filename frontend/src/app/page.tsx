    ...
    <div className="bg-white">
      ...
      <main className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-[#fcfcfc] px-6">
        <div className="max-w-4xl text-center space-y-6">
          ...
          className="text-sm uppercase tracking-[0.4em] text-gray-400 font-medium text-center"
        >
        ...
        <motion.h1 
          ...
          className="text-6xl md:text-8xl lg:text-9xl font-light tracking-tight text-gray-900 uppercase leading-[1.1]"
        >
          Elegance in <span className="font-serif italic font-normal">Simplicity</span>
        </motion.h1>
        ...
        <motion.p 
          ...
          className="max-w-xl mx-auto text-base md:text-lg text-gray-500 leading-relaxed tracking-wide font-light"
        >
